...
Live UI / data-plane breakage: reproduce, isolate, evidence. In this guide, practices are skill-mapped TTPs: they tell you *when*, *why*, and *which command* — not a second copy of the full skill text. Open the skill when you execute.
...
[04-evidence-over-vibes](../concepts/04-evidence-over-vibes.md), [01-this-is-fine-stance](../concepts/01-this-is-fine-stance.md)
