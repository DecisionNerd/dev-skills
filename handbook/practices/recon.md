...
Tactical scout from git/issue/milestone → next skill in this pack.

## What it is

Tactical scout from git/issue/milestone → next skill in this pack. In this guide, practices are skill-mapped TTPs: they tell you *when*, *why*, and *which command* — not a second copy of the full skill text. Open the skill when you execute.
