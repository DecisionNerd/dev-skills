...
Logs, metrics, traces, analytics — visibility without PII storms.

## What it is

Logs, metrics, traces, analytics — visibility without PII storms. In this guide, practices are skill-mapped TTPs: they tell you *when*, *why*, and *which command* — not a second copy of the full skill text. Open the skill when you execute.
