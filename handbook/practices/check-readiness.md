...
Is the issue done enough to PR or close?

## What it is

Is the issue done enough to PR or close? In this guide, practices are skill-mapped TTPs: they tell you *when*, *why*, and *which command* — not a second copy of the full skill text. Open the skill when you execute.
