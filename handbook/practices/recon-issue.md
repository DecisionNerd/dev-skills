...
Deep implementation plan for one issue before coding.

## What it is

Deep implementation plan for one issue before coding. In this guide, practices are skill-mapped TTPs: they tell you *when*, *why*, and *which command* — not a second copy of the full skill text. Open the skill when you execute.
