...
Frontend craft companion — shape, audit, polish UI.

## What it is

Frontend craft companion — shape, audit, polish UI. In this guide, practices are skill-mapped TTPs: they tell you *when*, *why*, and *which command* — not a second copy of the full skill text. Open the skill when you execute.
...
[02-skills-as-named-cuts](../concepts/02-skills-as-named-cuts.md), [08-vision-tied-goals](../concepts/08-vision-tied-goals.md)
