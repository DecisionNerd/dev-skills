...
Architecture before scaffolding: tools, memory, evals, stop conditions. In this guide, practices are skill-mapped TTPs: they tell you *when*, *why*, and *which command* — not a second copy of the full skill text. Open the skill when you execute.
...
[05-agent-agency](../concepts/05-agent-agency.md), [07-stop-conditions](../concepts/07-stop-conditions.md)
