...
Product docs companion — init, fill, ADR, KISS.

## What it is

Product docs companion — init, fill, ADR, KISS. In this guide, practices are skill-mapped TTPs: they tell you *when*, *why*, and *which command* — not a second copy of the full skill text. Open the skill when you execute.
...
[08-vision-tied-goals](../concepts/08-vision-tied-goals.md), [02-skills-as-named-cuts](../concepts/02-skills-as-named-cuts.md)
