...
Recover or write why the project exists before picking tools.

## What it is

Recover or write why the project exists before picking tools. In this guide, practices are skill-mapped TTPs: they tell you *when*, *why*, and *which command* — not a second copy of the full skill text. Open the skill when you execute.
...
[08-vision-tied-goals](../concepts/08-vision-tied-goals.md), [01-this-is-fine-stance](../concepts/01-this-is-fine-stance.md)

## Agent skill

`idk-now vision · document-it · DocSlime`
